...
public class Carnaval {
	...
	case 3:
		...
		if (valor2 * PNH > expec2) {
			System.out.println("O valor das Penas de Avestruz do Himalaia foi excedido. Valor gasto: R$" + valor2 * PNH);
		}
		if (valor3 * TSH > expec3) {
			System.out.println("O valor do tecido de seda Húngara foi excedido. Valor gasto: R$" + valor3 * TSH);}
		break;
	case 4:
